...
tact = @(s) (2*pi/sqrt(abs(vp(r2_crit))*vp(eq1)))*exp(2*(V(r2_crit)-V(eq1))./(s.^2));

noises = [0.0053,0.011,0.016,0.0213];

figure
loglog(noises,1./tact(noises),'color','blue')
