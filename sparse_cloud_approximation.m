...
for i=1:n-1
    S(i+1) = S(i) + dt*A1*w + sqrt(dt)*A1*s*randn();
...
figure
plot(sqrt(x),100*(RHeq(sqrt(x))-1),'LineWidth',2,'color','cyan')
hold on
plot(R,100*S,'color',[0.5,0.5,0.5],'LineWidth',1.5)
axis([0,5,0.00,0.12])
